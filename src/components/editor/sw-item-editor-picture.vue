...
<b-row><b-col>
    <!-- 最大幅 -->
    <sw-item-parts-number v-model:number="rf_item_max_width" v-model:result="rf_item_max_width_result"
            :item_subject='get_language(locale,"subject_max_width")' :item_placeholder='get_language(locale,"placeholder_max_width")' 
            :item_min_number=80 :item_max_number=1920 item_required />
</b-col><b-col>
    <!-- 最大高さ -->
    <sw-item-parts-number v-model:number="rf_item_max_height" v-model:result="rf_item_max_height_result"
            :item_subject='get_language(locale,"subject_max_height")' :item_placeholder='get_language(locale,"placeholder_max_height")' 
            :item_min_number=80 :item_max_number=1920 item_required />
</b-col></b-row>
</div>
</template>
...
// 最大幅
const rf_item_max_width = ref(80)
const rf_item_max_width_result = ref(false)
// 最大高さ
const rf_item_max_height = ref(80)
const rf_item_max_height_result = ref(false)
...
watch([ rf_item_name,rf_item_placeholder,rf_item_description,rf_item_key,
        ...
        rf_item_max_width,rf_item_max_height,rf_item_droparea_view_selected ], () => {
...
onBeforeMount(() => { 
    ...
    if( props.init_item_info !== null ){
        ...
        // 最大幅
        if( props.init_item_info.item_max_width !== undefined ){ rf_item_max_width.value = props.init_item_info.item_max_width; }
        // 最大高さ
        if( props.init_item_info.item_max_height !== undefined ){ rf_item_max_height.value = props.init_item_info.item_max_height; }
    }
});
// -----------------------------------------------
...
const is_result_value = () => {
    if( rf_item_name_result.value && 
        ...
        rf_item_max_width_result.value &&
        rf_item_max_height_result.value ){
        return true
    } else {
        return false
    }
...
const get_form_data = () => {
    ...
    form_data.item_max_width = Number(rf_item_max_width.value)
    form_data.item_max_height = Number(rf_item_max_height.value)
