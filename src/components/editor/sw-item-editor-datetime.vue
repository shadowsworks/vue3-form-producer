...
// 出力フォーマット
const rf_item_output_format = ref("ShortDateTime")
...
const local_output_format_select_columns = [
    { text: moment().format("YYYY/MM/DD HH:mm"), value: "ShortDateTime1" },
    { text: moment().format("YYYY-MM-DD HH:mm"), value: "ShortDateTime2" },
    { text: moment().format("YYYY-MM-DDTHH:mm:00"), value: "ShortDateTime3" },
    { text: moment().format("lll"), value: "MediumDateTime" },
    { text: moment().format("llll"), value: "LongDateTime" }
]
...
watch([ rf_item_name,rf_item_description,rf_item_key,
        ...
        //console.log("sw-item-editor-datetime:watch:-------")
        watch_task()
        setTimeout(() => {
            watch_task()
        }, 100);
...
const get_form_data = () => {
    ...
    //console.log("sw-item-editor-datetime:get_form_data="+JSON.stringify(form_data))
    return form_data
}
</script>
